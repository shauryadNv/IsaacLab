...
gym.register(
    id="IsaacContrib-Deploy-DisplayportInsertion-Rizon4s-Grav-Nominal-DR-Newton-IK-PhysXProfile-Scale050",
    entry_point=_INSERTION_ENV_ENTRY,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.ik_newton_env_cfg:"
            "Rizon4sGravDisplayportInsertionDomainRandomizedIKNewtonPhysXProfileScale050EnvCfg"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:Rizon4sGravDisplayportInsertionRNNPPORunnerCfg",
    },
)
...
gym.register(
    id="IsaacContrib-Deploy-DisplayportInsertion-Rizon4s-Grav-Nominal-DR-Newton-IK-PhysXProfile-Scale075",
    entry_point=_INSERTION_ENV_ENTRY,
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.ik_newton_env_cfg:"
            "Rizon4sGravDisplayportInsertionDomainRandomizedIKNewtonPhysXProfileScale075EnvCfg"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:Rizon4sGravDisplayportInsertionRNNPPORunnerCfg",
    },
)
