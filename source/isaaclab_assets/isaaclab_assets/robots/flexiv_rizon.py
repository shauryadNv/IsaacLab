...
FLEXIV_RIZON4S_GRAV_GRIPPER_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        joint_pos={
            ...
            "joint6": 0.785,
            "joint7": 0.0,
            # Grav gripper joints - opened position (45 degrees = 0.785 rad)
            "finger_joint": math.radians(45.0),
            # Initialize passive joints to 0
            ".*_knuckle_joint": 0.0,
        },
        pos=(0.0, 0.0, 0.0),
        rot=(1.0, 0.0, 0.0, 0.0),
    ...
    actuators={
        # Joints 1-2: Higher torque (123 Nm), lower speed (120°/s = 2.094 rad/s)
        # Stiffness/damping tuned for stable position control (similar to UR10e shoulder)
        "shoulder": ImplicitActuatorCfg(
            joint_names_expr=["joint[1-2]"],
            effort_limit_sim=123.0,
            velocity_limit_sim=2.094,
